...
![Build and Scan](https://github.com/ghosted123-sudo/devops-tp-docker-Edouard-CAPGRAS/actions/workflows/docker-deploy.yml/badge.svg)
![CodeQL](https://github.com/ghosted123-sudo/devops-tp-docker-Edouard-CAPGRAS/actions/workflows/codeql-analysis.yml/badge.svg)
...
```bash
docker pull ghcr.io/ghosted123-sudo/devops-tp-docker-Edouard-CAPGRAS:main
docker run -p 8080:8080 ghcr.io/ghosted123-sudo/devops-tp-docker-Edouard-CAPGRAS:main

Accéder à : http://localhost:8080

##Scan de Sécurité Local

trivy image ghcr.io/ghosted123-sudo/devops-tp-docker-Edouard-CAPGRAS:main
